...
BRONZE_TABLE = "lh_bronze.dbo.openaq_measurements_hourly"
SILVER_TABLE = "lh_silver.dbo.openaq_measurements_hourly"
...
clean = (new_bronze
    ...
    .filter(F.col("hour_utc").between(0, 23))
    .withColumn("row_num", F.row_number().over(
        Window.partitionBy("sensor_id", "date_utc", "hour_utc", "parameter")
